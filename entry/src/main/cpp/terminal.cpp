...
#include "hilog/log.h"
#undef LOG_TAG
#define LOG_TAG "DevBox-MiniTerm"
...
term_style::term_style() {
    fg_red = predefined_colors[white][0] / 255.0;
    fg_green = predefined_colors[white][1] / 255.0;
    fg_blue = predefined_colors[white][2] / 255.0;
    bg_red = predefined_colors[black][0] / 255.0;
    bg_green = predefined_colors[black][1] / 255.0;
    bg_blue = predefined_colors[black][2] / 255.0;
}
...
static int font_height = 36;
static int font_width = 18;
static int max_font_width = 36;
...
static void LoadFont() {
    ...
    std::vector<std::pair<const char *, font_weight>> fonts = {
        {"/data/storage/el1/bundle/entry/resources/resfile/Inconsolata-Regular.ttf", font_weight::regular},
        {"/data/storage/el1/bundle/entry/resources/resfile/Inconsolata-Bold.ttf", font_weight::bold},
    };
...
static void Draw() {
    ...
    glClearColor(predefined_colors[black][0] / 255.0, predefined_colors[black][1] / 255.0, predefined_colors[black][2] / 255.0, 1.0f);
